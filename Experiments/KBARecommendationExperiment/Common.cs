...
using ML.KBARecommendation.ClassificationExperiment;
...
namespace Common
{
    public static class ConsoleHelper
    {
        ...
        public static TestResult PrintMultiClassClassificationTestMetrics(string name, DataInput[] trainingData, string columnName, PredictionEngine<DataInput, DataPrediction> engine, MulticlassClassificationMetrics metrics)
        {
            ...
            foreach (DataInput row in trainingData)
            {
                ...
                Func<DataInput, string> getCorrectValue = i => (string)i.GetType().GetProperty(columnName).GetValue(i, null);
        ...
        public static TestResult GetMultiClassClassificationTestMetrics(string name, DataInput[] trainingData, string columnName, PredictionEngine<DataInput, DataPrediction> engine, MulticlassClassificationMetrics metrics)
        {
            name = name.Substring(name.LastIndexOf(".") + 1);
            ...
            foreach (DataInput row in trainingData)
            {
                ...
                Func<DataInput, string> getCorrectValue = i => (string)i.GetType().GetProperty(columnName).GetValue(i, null).ToString();
