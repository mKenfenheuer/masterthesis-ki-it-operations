...
using ML.IncidentClassification.ClassificationExperiment;
...
namespace Common
{
    public static class ConsoleHelper
    {
        ...
        public static TestResult PrintMultiClassClassificationTestMetrics(string name, IncidentInput[] trainingData, string columnName, PredictionEngine<IncidentInput, IncidentPrediction> engine, MulticlassClassificationMetrics metrics)
        {
            ...
            foreach (IncidentInput row in trainingData)
            {
                ...
                Func<IncidentInput, string> getCorrectValue = i => (string)i.GetType().GetProperty(columnName).GetValue(i, null);
        ...
        public static TestResult GetMultiClassClassificationTestMetrics(string name, IncidentInput[] trainingData, string columnName, PredictionEngine<IncidentInput, IncidentPrediction> engine, MulticlassClassificationMetrics metrics)
        {
            name = name.Substring(name.LastIndexOf(".") + 1);
            ...
            foreach (IncidentInput row in trainingData)
            {
                ...
                Func<IncidentInput, string> getCorrectValue = i => (string)i.GetType().GetProperty(columnName).GetValue(i, null).ToString();
